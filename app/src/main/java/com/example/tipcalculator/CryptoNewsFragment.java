...
public class CryptoNewsFragment extends Fragment {
    ...
    public static ArrayList<StockNewsData> cryptoNews = new ArrayList<StockNewsData>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new MarketNewsAdapter(cryptoNews);
        recyclerView.setAdapter(adapter);

        newsTopicTitle = thisView.findViewById(R.id.newsTopicTitle);
        newsTopicTitle.setText("Crypto News:");
