...
public class TechnologyNewsFragment  extends Fragment {
    ...
    public static ArrayList<StockNewsData> technologyNews = new ArrayList<StockNewsData>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myOnClickListener = new TechnologyNewsFragment.MyOnClickListener(getContext());
        ...
        adapter = new MarketNewsAdapter(technologyNews);
        recyclerView.setAdapter(adapter);

        newsTopicTitle = thisView.findViewById(R.id.newsTopicTitle);
        newsTopicTitle.setText("Technology News:");
