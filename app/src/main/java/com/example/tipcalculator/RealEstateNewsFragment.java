...
public class RealEstateNewsFragment extends Fragment {

    static MyOnClickListener myOnClickListener;
    private static RecyclerView recyclerView;
    private LinearLayoutManager layoutManager;
    public static ArrayList<StockNewsData> realEstateNews = new ArrayList<StockNewsData>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myOnClickListener = new RealEstateNewsFragment.MyOnClickListener(getContext());
        ...
        adapter = new MarketNewsAdapter(realEstateNews);
        recyclerView.setAdapter(adapter);

        newsTopicTitle = thisView.findViewById(R.id.newsTopicTitle);
        newsTopicTitle.setText("Real Estate News:");
